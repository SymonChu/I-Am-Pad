...
import com.impad.pro.bridge.IHookBridge.IMemberHookCallback
import com.impad.pro.bridge.IHookBridge.MemberUnhookHandle
...
class ArtHookBridge : IHookBridge {
    ...
    private fun generateBridgePair(target: Executable): BridgePair {
        ...
        val fqn = $$"$${"com.impad.pro"}.loader.entry.zygisk.WkBr$$$suffix"
