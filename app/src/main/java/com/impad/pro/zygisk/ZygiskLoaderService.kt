...
import com.impad.pro.bridge.IClassLoaderHelper
import com.impad.pro.bridge.ILoaderService
...
internal class ZygiskLoaderService(
    ...
    override val entryPointName: String = "com.impad.pro.zygisk.ZygiskEntry"
