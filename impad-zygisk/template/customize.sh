...
ui_print "- Extracting impad payload"
mkdir -p "$MODPATH/payload"
extract "$ZIPFILE" "payload/impad.apk" "$MODPATH"
extract_payload_dex "$MODPATH/payload/impad.apk" "$MODPATH/payload"
ui_print "  impad payload installed to $MODPATH/payload"
